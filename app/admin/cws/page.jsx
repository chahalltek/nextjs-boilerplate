...
export default function AdminCwsPage() {
  ...
  async function onCreate(e) {
    ...
    try {
      ...
      // reset a bit, but keep date for convenience
      setSlug("");
      setTitle("");
      setExcerpt("");
      setContent("");
      ...
      // reload list
      await load();
      // focus content box for next entry if you like
  ...
  return (
    <div className="container max-w-5xl py-10 space-y-8">
      ...
      {/* Create new recap */}
      <form onSubmit={onCreate} className="card p-5 space-y-4">
        <h2 className="text-lg font-semibold">Create / Save Recap</h2>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-xs text-white/50 mt-1">
              File will be saved as <code>content/recaps/&lt;slug&gt;.md</code>
            </p>
          </div>
